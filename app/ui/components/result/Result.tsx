...
const Result = () => {
	...
	useEffect(() => {
		...
		const addParticipantfunc = async () => {
			await addParticipant(teamIdentifier, {
				name: username,
	...
	}, [teamIdentifier, username, correct_count, twitterId, instagramId]);
	...
	// 正解数順にソート
	const sortedRanking = [...userRanking].sort((a, b) => b.correct_count - a.correct_count);
